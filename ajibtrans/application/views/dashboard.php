                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="container">
                        <div class="row mb-4">
                            ...
                            <div class="col-6 col-sm-4">
                                <p><i class="fa fa-check text-primary me-3"></i>Avanza</p>
                                <p><i class="fa fa-check text-primary me-3"></i>Bus Medium</p>
                    ...
                    <a class="btn btn-primary rounded-pill py-3 px-5 mt-2"
                        href="https://wa.me/<?= $konfig->no_wa; ?>?text=Halo, selamat siang, saya mau sewa mobil ...."
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-white text-center h-100 p-4 p-xl-5">
                        ...
                        <p class="mb-4">AjibTrans pasti menempatkan kenyamanan dan keamanan pelanggan sebagai
                            prioritas utama, dengan mengadopsi standar keamanan dan perawatan yang rutin untuk
                            armadanya.</p>
                    </div>
                </div>
                                ...
                                <div class="product-item">
                                    ...
                                    <div class="d-flex border-top">
                                        ...
                                        <small class="w-50 text-center py-2">
                                            <a class="text-body" href="https://wa.me/<?= $konfig->no_wa; ?>?text=Halo, selamat siang, saya mau sewa mobil <?= $uu['judul'] ?> bisa?"><i class=""></i>
                                                <?= $uu['status'] ?>
                                            </a>
                                        </small>
                                    </div>
