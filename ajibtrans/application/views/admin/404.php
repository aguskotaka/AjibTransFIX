...
>
  <head>
    ...
    <title>Error Pages | Rippky</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('assets/sneat') ?>/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">Halaman Tidak Tersedia :(</h2>
        <p class="mb-4 mx-2">Oops! 😖 The requested URL was not found on this server.</p>
        <a href="<?= base_url('admin/dashboard') ?>" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
            src="<?= base_url('assets/sneat') ?>/assets/img/illustrations/page-misc-error-light.png"
