<div class="card">
    <h4 class="card-header">Data Galeri</h4>
    <div class="container-fluid pt-0 px-3">
        <a type="button" href="<?= base_url('admin/Galeri/input_galeri') ?>" class="btn btn-primary">Tambahkan
            Foto !</a>
    </div>
    <br>
                            ...
                            <?php foreach ($galeri as $aa) { ?>
                                <div class="col-md-6 col-lg-4 mb-3 ">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <a href="<?= base_url('admin/galeri/hapus/' . $aa['foto']) ?>"
